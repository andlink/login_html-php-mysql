...
/** *********************************************************** 
	...
	** STATUS LIST **
	...
	$status_int (Integer) - status number
	
	return $status_str (String) - status string
**/
function get_auth_status_str() {	
	$status_str = '';
	switch (get_auth_status()) {
		case 1: $status_str = 'NOT LOGGED'; break;
		case 2: $status_str = 'LOGGED'; break;
		case 3: $status_str = 'INVALID PARAMETERS'; break;
		case 4: $status_str = 'AUTHENTICATION FAILED'; break;
	}
